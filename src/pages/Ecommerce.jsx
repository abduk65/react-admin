        ...
        bg-no-repeat bg-cover bg-center">
          <div className="flex-justify-between items-center">
            <div>
              ...
              <p className='text-2xl'>$6,454,344</p>
            </div>
          </div>
          <div className="mt-6">
          ...
          {earningData.map((item) => (
            ...
            md:w-56 p-4 pt-9 rounded-2xl">
              ...
              <p className="mt-3">
                ...
                <span className={`text-sm text-${item.color} ml-2`}>{item.percentage}</span>
              </p>
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$93,324</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$48,324</span>
                </p>
                <p className='text-gray-500 mt-1'>Expense</p>
              </div>
              <div className='mt-5'>
                <SparkLine
                  currentColor="red" id="line-sparkline" type="Line"
                  height="80px" width="250px" data={SparklineAreaData} color="red" />
              </div>
              <div className="m-10">
                <Button
