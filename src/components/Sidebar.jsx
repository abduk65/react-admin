...
const handleCloseSideBar = ()=>{
  ...
  const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white bg-green-400 text-md m-2'
          ...
          <>
            <div className="flex justify-between items-center">
              ...
              <TooltipComponent content="menu" position="BottomCenter">
                <button type='button' onClick={() => setActiveMenu((prevActiveMenu) => !prevActiveMenu)} className="text-xl block ml-15 rounded-full hover:bg-light-gray p-3 mt-4 block">
                  <MdOutlineCancel />
                </button>
              </TooltipComponent>
            </div>
